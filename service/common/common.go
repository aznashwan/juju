...
type Conf struct {
	...
	// Currently not used on Windows or systemd-based systems.
	...
	// defaults to "~/.config/systemd/user" on systemd-based systems.
	// Currently not used on Windows.
	InitDir string
	// ExtraScript allows the insertion of a script before command execution.
	// Currently unused under Windows or systemd-based systems.
	ExtraScript string
}
